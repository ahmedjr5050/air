...
import 'package:air/widgets/double_text_widget.dart';
import 'package:air/widgets/icon_text_widget.dart';
      ...
      body: ListView(
        ...
        children: [
         ...
         const AppIconText(icon: Icons.flight_takeoff_rounded, text: "Departure"),
          ...
          Gap(AppLayout.getHeight(25)),
          Container(
    padding: EdgeInsets.symmetric(horizontal: AppLayout.getWidth(18),vertical: AppLayout.getWidth(15)),
    decoration: BoxDecoration(
