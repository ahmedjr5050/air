import 'package:air/utils/Styles.dart';
import 'package:air/utils/app_layout.dart';
import 'package:air/widgets/thick_container.dart';
...
class TicketView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //use sizeBox because its Fixed Size
    return SizedBox(
                       ...
                       child: LayoutBuilder(
                         builder: (BuildContext context, BoxConstraints constarints) {
                           ...
                           return Flex(
                             ...
                             children: List.generate((constarints.constrainWidth()/6).floor(), (index) => SizedBox(
                  ...
                  Expanded(child: Padding(
                    ...
                    child: LayoutBuilder
                     ...
                     return Flex(
                        ...
                        mainAxisSize: MainAxisSize.max,
                        children:
                          List.generate((constraints.constrainWidth()/15).floor(), (index) => const SizedBox(
                            width: 5,height: 1,
                            child: DecoratedBox(
                              decoration: BoxDecoration(
                                color: Colors.white
